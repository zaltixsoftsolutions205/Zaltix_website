...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 min-h-[100svh] flex items-center px-4 sm:px-6 lg:px-12">
        <div className="max-w-7xl mx-auto w-full">
          <div className="max-w-xl sm:max-w-2xl lg:max-w-3xl space-y-6 sm:space-y-8">
            ...
            <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-gray-200 max-w-2xl">
              {videos[currentVideo].description}
            </p>
            ...
            <div className="pt-2">
              <button
                ...
                className="glass-button text-white hover:text-gray-900 text-sm sm:text-base md:text-lg px-6 sm:px-8 py-3 sm:py-4"
              >
                Let&apos;s Build Your Solution
              </button>
            </div>
            ...
            <div className="flex items-center gap-3 sm:gap-4 pt-4">
              <button
                onClick={prevVideo}
                className="glass-card p-2 sm:p-3 rounded-full hover:scale-110 transition"
              >
