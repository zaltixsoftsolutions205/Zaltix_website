...
const services = [
  {
    slug: "web-mobile-systems",
    icon: Globe,
    title: "Web & Mobile Application Systems",
    short: "Operational platforms designed around real business workflows.",
    description:
      "We design and build connected web and mobile systems that become the backbone of operations — not isolated applications.",
    points: [
  ...
  },
  {
    ...
    short: "Standardized execution across teams and processes.",
    description:
      "Automation systems that remove manual effort, reduce errors, and bring consistency across sales, finance, HR, and operations.",
    points: [
  ...
  },
  {
    ...
    short: "Real-time insight into performance and execution.",
    description:
      "We create live visibility into operations and outcomes so leaders can act while it still matters.",
    points: [
  ...
  },
  {
    ...
    short: "Embedded intelligence inside daily operations.",
    description:
      "Decision intelligence surfaces risks, priorities, and next actions automatically — before issues impact outcomes.",
    points: [
  ...
  },
  {
    ...
    short: "Context-aware assistance inside systems.",
    description:
      "AI assistants embedded into platforms to help teams understand data, navigate complexity, and act faster.",
    points: [
      "System explanations",
  ...
  },
  {
    ...
    short: "Infrastructure built for growth and reliability.",
    description:
      "Secure, scalable cloud foundations that support integrations, growth, and long-term reliability.",
    points: [
...
const ServicesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="pt-24 sm:pt-28 pb-16 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto">
            We help growing companies remove operational chaos and build systems
            that scale with clarity and control.
          </p>
        </div>
      </section>

      {/* SERVICES LIST (MOBILE-FIRST) */}
      <section className="pb-16 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 mb-8 sm:mb-10 text-center">
            Our Core Services
          </h2>
          ...
          <div className="grid gap-4 sm:gap-6 sm:grid-cols-2">
            {services.map((service, index) => (
              <div
                key={index}
                className="flex items-start gap-4 bg-white border border-slate-200 rounded-xl p-5 sm:p-6"
              >
      ...
      <section className="pb-20 sm:pb-24 px-4 sm:px-6 bg-white">
        <div className="max-w-7xl mx-auto grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
          {services.map((service, index) => (
            <div
              key={index}
              className="border border-slate-200 rounded-2xl p-6 sm:p-8 hover:shadow-xl transition"
            >
              ...
              <button
                onClick={() => navigate(`/services/${service.slug}`)}
                className="text-indigo-600 font-semibold text-sm sm:text-base hover:underline"
              >
                View service →
              </button>
            </div>
